...
/**
 * This object represents a parameter from the $_REQUEST superglobal.
 * 
 * @author David Négrier
 */
class RequestParam implements ScalarValueInterface, ArrayValueInterface {
	...
	/**
	 * @Important $paramName
	 * @param string $paramName The REQUEST parameter this object represents
